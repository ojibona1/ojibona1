...
<p align="center">
  ...
  Passionate about user experience, performance optimization, and cutting-edge web technologies.
</p>

---

- 🔭 I've built a **multi-chain crypto wallet** supporting Ethereum, Solana, Bitcoin, Tron & Ripple
...
|--------|-------|-------------|
| **BlockSign App** | React Native, Expo, TypeScript, Blockchain | Secure multi-chain crypto wallet with biometric auth & AES encryption |
| **Ascent Capital** | React, Node.js, MongoDB, Stripe | Fintech investment platform with financial dashboards & subscription payments |
| **Public Dripper** | MERN, Stripe, Google OAuth | Luxury e-commerce platform with secure payments & admin management |
| **Game Buddy** | React, AI Integration | AI-powered e-commerce store with personalised recommendations |
| **Drill WebGI** | WebGI, Three.js, GSAP | Immersive 3D product showcase with cinematic animations |
